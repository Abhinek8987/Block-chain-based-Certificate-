                    ...
                    <div>
                      ...
                      {selectedLanguage && (
                        <p className="mt-3 text-sm text-gray-600 p-3 bg-gray-50 rounded-lg">
                          Selected: <span className="font-medium text-indigo-600">{selectedLanguage.nativeName}</span>
                        </p>
                      )}
                    </div>
                  </div>
              ...
              <div className={`bg-white rounded-2xl border border-gray-200 p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 ${isAnimating ? 'opacity-100' : 'opacity-0'}`}
                ...
                {languages.length > 0 ? (
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {languages.slice(0, 10).map((lang) => (
                        ...
                        >
                          <div className={`w-3 h-3 rounded-full flex-shrink-0 mr-3 ${
                            formData.language === lang.code ? 'bg-indigo-600' : 'bg-gray-300'
                          }`}></div>
                    ...
                    {languages.length > 10 && (
                      <div className="text-center">
                        <div className="inline-flex items-center gap-2 text-sm text-gray-600 bg-gray-50 rounded-full px-4 py-2">
                          <span className="font-medium">+{languages.length - 10}</span>
                          <span>more languages available</span>
                        </div>
                      </div>
                    )}
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-500 mt-4">Loading languages...</p>
                  </div>
                )}
              </div>
            </div>
